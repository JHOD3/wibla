...
@section('content')
  <section>
    <div class="container position-absolute-md absulute-center py-section-home d-md-flex d-block pt-5 px-md-5 position-absolute center-image-absolute" style="z-index: 99;">
      <div class="col-md-6 col-12 mt-container-home mt-md-5">
        <div class="pl-md-5">
          <h1 class="montserrat text-md-left text-dark font35-px text-md-center"> Imagen y Tecnología para</h1>
          <embed class="creadores-text" src="{{ asset('image/creadores_y_exploradores.png')}}" type=""/>
        </div>
      </div>
  ...
  <section>
    <div class="position-absolute center-image-absolute">
      <div class="col-md-8 mx-auto d-flex justify-content-center pt-md-5 mt-md-5 mt-4">
        <embed class="vision-text" src="{{ asset('image/nuestra_vision.png')}}" type=""/>
      </div>
